...
class Advisory(models.Model):
    ...
    weekly_record = models.ForeignKey('pest_scouting.WeeklyRecord', on_delete=models.CASCADE, related_name='advisories')
    ...
    actions_taken = models.CharField(max_length=500, null=True, blank=True)
