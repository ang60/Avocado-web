...
import { 
  ...
  MessageSquare, Send, AlertCircle, CheckCircle, Calendar, Eye, Link2
} from 'lucide-react';
...
interface FarmerData {
  ...
  linkedExporter?: string; // ID of linked exporter
}
...
const farmersData: FarmerData[] = [
  {
    ...
    overdueScouts: false,
    linkedExporter: '1', // Linked to Vegpro
  },
  {
    id: 'FRM-1023',
    name: 'Grace Wanjiku',
    ...
    overdueScouts: true,
    linkedExporter: '2', // Linked to FreshPack
  },
  {
    id: 'FRM-1022',
