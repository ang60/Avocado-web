...
import com.avocado.android.databinding.Alerts2LayoutBinding;
...
public class AlertsAdapter extends RecyclerView.Adapter<AlertsAdapter.ViewHolder> implements Filterable {
    ...
    public AlertsAdapter(AlertsListener alertsListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Alerts2LayoutBinding binding = Alerts2LayoutBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        Alerts2LayoutBinding binding;

        ViewHolder(Alerts2LayoutBinding binding) {
        ...
        private void setLogo(Drawable drawable) {
            binding.alerts2LayoutLogoImageView.setImageDrawable(drawable);
        }
        ...
        private void setLogoTint(Alert alert, int resource) {
            ...
            binding.alerts2LayoutLogoImageView.setImageTintList(ContextCompat.getColorStateList(binding.getRoot().getContext(), resource));
        }

        private void setLogoBackground(int resource) {
            binding.alerts2LayoutLogoImageView.setBackgroundResource(resource);
        }

        private void setBackground(int resource) {
            binding.alerts2LayoutLinearLayout.setBackgroundResource(resource);
        }

        private void setTitle(String title) {
            binding.alerts2LayoutTitleTextView.setText(title);
        }

        private void setSubTitle(String subTitle) {
            binding.alerts2LayoutSubTitleTextView.setText(subTitle);
        }

        private void setDate(String date) {
            binding.alerts2LayoutDateTextView.setText(date);
        }
